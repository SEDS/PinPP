...
// $PIN_ROOT/pin -t $PINPP_ROOT/lib/simple_sampling_reservoir.dll -p <percentage> -f -- <program>
KNOB <double> reservoir_sampling_native::percentage_ (KNOB_MODE_WRITEONCE, "pintool", "p", "20.0", "specify the sampling percentage");
KNOB <string> reservoir_sampling_native::outfile_ (KNOB_MODE_WRITEONCE, "pintool", "f", "simple_sampling_reservoir.out", "specify output file name");
