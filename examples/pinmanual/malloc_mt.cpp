...
public:
  ...
  void handle_thread_start (THREADID thr_id, OASIS::Pin::Context & ctx, INT32 code)
  {
    OASIS::Pin::Guard <OASIS::Pin::Lock> guard (this->lock_);
  ...
  void handle_thread_fini (THREADID thr_id, const OASIS::Pin::Context & ctx, INT32 code)
  {
    OASIS::Pin::Guard <OASIS::Pin::Lock> guard (this->lock_);
